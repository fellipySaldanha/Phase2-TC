...
import { DeleteCustomerInputDTO, DeleteCustomerOutputDTO } from "./DeleteCustomerDTO";
...
export default class DeleteCustomer implements UseCaseInterface{
    ...
    async execute(input: DeleteCustomerInputDTO): Promise<DeleteCustomerOutputDTO> {
        try {
