...
import { GetOrderQueueInputDTO, GetOrderQueueOutputDTO, orderqueueInfo } from "./GetOrderQueueDTO";

export class GetOrderQueueUseCase {
    static async execute(params: GetOrderQueueInputDTO, gateway: IOrderQueueGateway): Promise<GetOrderQueueOutputDTO> {
